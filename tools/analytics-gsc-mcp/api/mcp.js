// Self-contained on purpose: importing from ../src/server.js caused Vercel's
// zero-config Node builder to pick that module as the function entry instead
// of this file. Keeping everything in one file avoids that ambiguity.
